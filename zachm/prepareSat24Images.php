<?php
 ...
 $regionsZoomOffsets = array('','x=1950&y=880','x=2280&y=880','x=1950&y=1140','x=2280&y=1140');
 if ($region == 0 ) {
    ...
    <div style="float:left">
      <div style="display:inline-block;vertical-align:middle">
        <div style="position:relative;
          ...
          <select style="vertical-align:middle;height:38px;"
            onchange="window.location='./zachm?region=' + this.value + '&amp;interval=$interval'">
            $optionsRegion
          </select>
        </div>
      </div>
    ...
    <div style="float:right;">
      <div style="display:inline-block;vertical-align:middle">
        <div style="position:relative;
          ...
          <select style="vertical-align:middle;height:38px;"
            onchange="window.location='./zachm?region=$region&amp;interval=' + this.value">
            $optionsInterval
          </select>
        </div>
      </div>
